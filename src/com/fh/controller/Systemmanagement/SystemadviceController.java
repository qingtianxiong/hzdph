...
/** 
 * 绫诲悕绉帮細SystemadviceController
 * 鍒涘缓浜猴細FH 
 * 鍒涘缓鏃堕棿锛�2016-01-27 
 */
@Controller
@RequestMapping(value="/Systemadvice")
public class SystemadviceController extends BaseController {
	
	String menuUrl = "Systemadvice/list.do"; //鑿滃崟鍦板潃(鏉冮檺鐢�)
	/**
	 * 鍒楄〃
	 */
	@RequestMapping(value="/list")
	public ModelAndView list(Page page){
		logBefore(logger, "鍒楄〃Systemadvice");
		...
		try{
			...
			mv.setViewName("Systemmanagement/Systemadvice_list");
