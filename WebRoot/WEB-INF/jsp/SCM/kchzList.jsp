		...
		<div id="page-content" class="clearfix">
			...
			<div class="row-fluid">
				...
				<div class="row-fluid">
					...
					<!-- 检索  -->
					<form action="kchz/xlist.do" method="post" name="Form" id="Form">
						<table>
							<tr>
								<td>查询：</td>
										...
										<c:if test="${QX.cha == 1 }">
											<c:forEach items="${varList}" var="var" varStatus="vs">
												<tr>
												    ...
												    <td style="text-align:right">${var.DEPAMT}</td>
												    <td style="text-align:right">${var.LSJE}</td>
												    <td style="text-align:right">${var.JXCE}</td>											    
												    <td style="text-align:right">${var.RECE_COST}</td>
												    <%-- <td style="width: 30px">
