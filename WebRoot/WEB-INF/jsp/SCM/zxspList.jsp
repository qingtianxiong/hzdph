		...
		<div id="page-content" class="clearfix">
			...
			<div class="row-fluid">
				...
				<div class="row-fluid">
					...
					<!-- 检索  -->
					<form action="xsbb/zxsplist.do" method="post" name="Form" id="Form">
						<table>
							<tr>
								<td>查询：</td>
											...
											<c:forEach items="${varList}" var="var" varStatus="vs">
												<tr>
												    ...
												    <td style="text-align:right">
												    	<c:if test="${var.DAYS > 60 }">
															<font style="color:red;font-weight:bold">${var.DAYS}</font>
														</c:if>
												    	<c:if test="${var.DAYS <= 60 }">
															${var.DAYS}
														</c:if>
												    ...
												    <td style="text-align:right">${var.SALES_DAYS}</td>	
												    <td style="text-align:right">${var.ONWAY}</td>
												    <td style="text-align:right">${var.EXEC_ID}</td>
												    <td style="text-align:right">${var.EXEC_DT}</td>											    
												    <td style="text-align:left">${var.MEMO}</td>
												    <%-- <td style="width: 30px">
