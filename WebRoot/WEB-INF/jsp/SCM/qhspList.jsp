		...
		<div id="page-content" class="clearfix">
			...
			<div class="row-fluid">
				...
				<div class="row-fluid">
					...
					<!-- 检索  -->
					<form action="xsbb/qhsplist.do" method="post" name="Form" id="Form">
						<table>
							<tr>
								<td>查询：</td>
						...
						<table id="table_report"
							...
							<thead>
								<tr>
									...
									<th class="center">可销售天数</th>
									<th class="center">在途订单</th>
									<th class="center">到货日</th>
										...
										<c:if test="${QX.cha == 1 }">
											<c:forEach items="${varList}" var="var" varStatus="vs">
												<tr>
												    ...
												    <td style="text-align:right">${var.DAYS}</td>											    
